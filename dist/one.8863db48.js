...
var Optimistic = function (_React$Component) {
  ...
  function Optimistic(props) {
    ...
    _this.state = { state: Optimistic.START_STATE };
    return _this;
  }
    ...
    value: function render() {
      ...
      return this.props.children({
        ...
        reset: function reset() {
          _this2.promise.cancelled = true;
          _this2.setState({ state: Optimistic.START_STATE });
        },
...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"one.js":[function(require,module,exports) {
var React = require('react');
    ...
    function (_ref) {
      ...
      return React.createElement(
        'button',
        {
          ...
          style: {
            background: state === Optimistic.START_STATE ? 'lightGreen' : state === Optimistic.FAILED_STATE ? 'tomato' : 'orange',
            padding: '10px',
            cursor: 'pointer',
        ...
        state === Optimistic.START_STATE ? 'Click me' : state === Optimistic.UPDATED_STATE ? 'Optimistic update!' : 'Failed state!'
      );
    }
  );
};

ReactDOM.render(React.createElement(ExampleOne, null), document.querySelector('#root'));
...
},{}]},{},["../../../.nvm/versions/node/v8.9.4/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","one.js"], null)
//# sourceMappingURL=/one.8863db48.map