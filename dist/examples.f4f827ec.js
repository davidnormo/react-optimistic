...
},{"./factoryWithTypeCheckers":"../../node_modules/prop-types/factoryWithTypeCheckers.js"}],"../index.js":[function(require,module,exports) {
...
var Optimistic = function (_React$Component) {
  ...
  _createClass(Optimistic, [{
    ...
    value: function getToggledState() {
      return this.state.state === Optimistic.NOT_UPDATED_STATE ? Optimistic.UPDATED_STATE : Optimistic.NOT_UPDATED_STATE;
    }
  }, {
    key: 'render',
      ...
      return this.props.children({
        ...
        updater: function updater(action) {
          return function () {
            ...
            return _this2.promise.then(function () {
              _this2.setState({
...
Optimistic.propTypes = {
  ...
  initialState: PropTypes.oneOf([Optimistic.NOT_UPDATED_STATE, Optimistic.UPDATED_STATE])
};

module.exports = Optimistic;
},{"react":"../../node_modules/react/index.js","prop-types":"../../node_modules/prop-types/index.js"}],"../../node_modules/fbjs/lib/ExecutionEnvironment.js":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
var React = require('react');
var Optimistic = require('../index');
var ReactDOM = require('react-dom');

var successfulAction = function successfulAction() {
...
var failedAction = function failedAction(e) {
  return e.preventDefault() || new Promise(function (res, rej) {
      ...
      function (_ref) {
        ...
        return React.createElement(
          'button',
          {
            ...
            style: {
              background: reqState === Optimistic.REJECTED_REQUEST_STATE ? 'tomato' : state === Optimistic.NOT_UPDATED_STATE ? 'lightGreen' : 'orange'
            } },
          reqState === Optimistic.REJECTED_REQUEST_STATE ? 'Failed state!' : state === Optimistic.UPDATED_STATE ? 'Optimistic update!' : 'Click me'
        );
      }
    ),
    React.createElement(
      ...
      React.createElement(
        'li',
        null,
        'click - optimistic update with success after 1.5 secs'
      ),
      React.createElement(
        'li',
        null,
        'right click - optimistic update with failure after 1.5 secs'
      ),
      React.createElement(
        'li',
        null,
        'focus button then press any key - reset to starting state'
      )
    ),
    React.createElement(
      'h3',
...
var ExampleTwo = function ExampleTwo() {
  return React.createElement(
    'div',
    null,
    React.createElement(
      'h2',
      null,
      'Throttled Toggle example'
    ),
    React.createElement(
      'p',
      null,
      'Prevents click spamming. While promise is pending, it doesn\'t accept new updates. After the request has resolved/rejected, new updates are accepted.'
    ),
    React.createElement(
      Optimistic,
      null,
      function (_ref2) {
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            {
              className: 'optimistic-btn',
              onClick: reqState === Optimistic.PENDING_REQUEST_STATE ? function () {} : updater(successfulAction)
            },
            state
          ),
...
var ExampleThree = function ExampleThree() {
  return React.createElement(
    'div',
    null,
    React.createElement(
      'h2',
      null,
      'Unthrottled Toggle example'
    ),
    React.createElement(
      'p',
      null,
      'Unlike the above example, this one lets you spam updates'
    ),
    React.createElement(
      Optimistic,
      null,
...
ReactDOM.render(React.createElement(
  ...
  React.createElement(ExampleTwo, null),
  React.createElement(ExampleThree, null)
), document.querySelector('#root'));
},{"react":"../../node_modules/react/index.js","../index":"../index.js","react-dom":"../../node_modules/react-dom/index.js"}],"../../../.nvm/versions/node/v8.9.4/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/examples.f4f827ec.map